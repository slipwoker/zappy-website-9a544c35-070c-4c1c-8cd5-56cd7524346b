document.addEventListener('DOMContentLoaded', function() {
  ...
  const animateElements = document.querySelectorAll('.fade-in, .animate-on-scroll, [data-animate]');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "כמו חדש משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '9a544c35-070c-4c1c-8cd5-56cd7524346b',
                    name: data.name || '',
                    email: data.email || '',
